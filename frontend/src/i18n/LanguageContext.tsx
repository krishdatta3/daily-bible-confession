...
const STRINGS: Dict = {
  ...
  // AI features (Gemini)
  ai_help: { hi: "AI आत्मिक सहायता", en: "AI Spiritual Help" },
  ai_online_note: { hi: "इसके लिए इंटरनेट आवश्यक है", en: "Requires internet" },
  ai_error: { hi: "क्षमा करें, अभी उत्तर नहीं मिल सका। कृपया इंटरनेट जाँचें।", en: "Sorry, couldn't get a response. Please check your internet." },
  gen_card_title: { hi: "मेरे लिए अंगीकार बनाएँ", en: "Create My Confession" },
  gen_card_desc: { hi: "अपनी स्थिति बताएँ, AI आपके लिए अंगीकार बनाएगा", en: "Share your situation, AI creates a confession for you" },
  gen_title: { hi: "व्यक्तिगत अंगीकार", en: "Personal Confession" },
  gen_prompt: { hi: "आज आपके मन में क्या है? अपनी स्थिति लिखें:", en: "What's on your heart today? Describe your situation:" },
  gen_placeholder: { hi: "जैसे: नौकरी की चिंता, स्वास्थ्य, परिवार, भय...", en: "e.g. worry about job, health, family, fear..." },
  gen_button: { hi: "अंगीकार बनाएँ", en: "Generate Confession" },
  gen_regenerate: { hi: "फिर से बनाएँ", en: "Regenerate" },
  gen_generating: { hi: "आपके लिए तैयार हो रहा है...", en: "Preparing for you..." },
  gen_confession_label: { hi: "आपका अंगीकार", en: "Your Confession" },
  gen_prayer_label: { hi: "प्रार्थना", en: "Prayer" },
  gen_empty_error: { hi: "कृपया अपनी स्थिति लिखें", en: "Please describe your situation" },
  assistant_card_title: { hi: "विश्वास सहायक से पूछें", en: "Ask the Faith Assistant" },
  assistant_card_desc: { hi: "बाइबल आधारित मार्गदर्शन व प्रोत्साहन", en: "Bible-based guidance & encouragement" },
  assistant_title: { hi: "विश्वास सहायक", en: "Faith Assistant" },
  assistant_greeting: { hi: "शालोम! 🙏 मैं आपका विश्वास सहायक हूँ। आप प्रार्थना, वचन या किसी भी आत्मिक विषय पर पूछ सकते हैं।", en: "Shalom! 🙏 I'm your faith assistant. Ask me about prayer, Scripture, or any spiritual matter." },
  assistant_placeholder: { hi: "अपना सवाल लिखें...", en: "Type your question..." },
  assistant_thinking: { hi: "सोच रहा हूँ...", en: "Thinking..." },
  reflect_button: { hi: "मनन", en: "Reflect" },
  reflect_title: { hi: "आज का मनन", en: "Today's Reflection" },
};
